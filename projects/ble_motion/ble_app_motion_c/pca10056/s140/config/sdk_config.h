...
// <o> BLE_MOTION_C_BLE_OBSERVER_PRIO  
// <i> Priority with which BLE events are dispatched to the Quaterion Orientation Service Client.

#ifndef BLE_MOTION_C_BLE_OBSERVER_PRIO
#define BLE_MOTION_C_BLE_OBSERVER_PRIO 2
#endif
